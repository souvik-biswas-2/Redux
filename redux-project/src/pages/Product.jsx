    ...
    return (
      <main className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
        ...
        <div className="flex items-center justify-center min-h-100">
          <Loader size={40} className="animate-spin text-indigo-600 dark:text-indigo-400" />
        </div>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      <section className="bg-gray-100 dark:bg-gray-800 py-12 px-4 transition-colors">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">{products.length} Premium Products Available</h2>
